  ...
  const DEFAULTS = {
    ...
    labelTemplates: {
      product_label: {
        ...
        show_parts: true,
        max_parts_lines: 5,
        frame:    { enabled: true, padding: 30, thickness: 3 },
        dividers: { enabled: true, thickness: 2, positions: [] },
        elements: {
          title:    { enabled: true, x: 770, y: 60, w: 1500, font: 55, lines: 2 },
          customer: { enabled: true, x: 620, y: 60, w: 1500, font: 32, lines: 2 },
          received: { enabled: true, x: 530, y: 60, w: 1500, font: 28, lines: 1 },
          code:     { enabled: true, x: 460, y: 60, w: 1500, font: 38, lines: 1 },
          parts:    { enabled: true, x: 380, y: 60, w: 1500, font: 26, lines: 5 },
          barcode:  { enabled: true, x: 60,  y: 60, w: 1500, h: 180 },
        },
      },
    },
  };
